 ...
 */
class Mobilization extends React.Component<{ blocks: any, editable: any, newBlockButton: any, blockWrapper: any, linkTo: any, blockWidgetsRef: any, widgets: any, widgetComponent: any, extraWidgetProps: any }, { blocks: any }> {
  ...
  public static defaultProps = {
    ...
    widgets: [],
    extraWidgetProps: {},
    blockWidgetsRef: (b: any, ws: any) => ws.filter((w: any) => w.block_id === b.id)
  }
  ...
  componentWillReceveProps(nextProps: any) {
  ...
  getVisibleBlocks ({ blocks, editable }: any) {
    const visibleBlocks = !editable ? blocks.filter((b: any) => !b.hidden) : blocks
  ...
  //     this.state.blocks.map((block: any, index: any) => {
  //       const { offsetTop, offsetHeight }: any = document.querySelector(`#${this.props.linkTo(block)}`)
  ...
  //     document.querySelector('#blocks-list').onscroll = ({ target }: any) => {
  //       //
  ...
  render () {
    ...
    const { colorScheme, headerFont, bodyFont }: any = this.props
